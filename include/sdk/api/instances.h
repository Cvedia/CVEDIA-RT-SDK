			...
			namespace instances {
				...
				struct EXPORT_CLASS InstanceWriteModel {
					...
					static InstanceWriteModel createDefault() {
						...
						auto constexpr persistent = defaults::solution_manager::persistent;
						auto constexpr frameRateLimit = defaults::solution_manager::frameRateLimit;
						auto constexpr metadataMode = defaults::solution_manager::metadataMode;
						auto constexpr statisticsMode = defaults::solution_manager::statisticsMode;
						auto constexpr diagnosticsMode = defaults::solution_manager::diagnosticsMode;
						auto constexpr debugMode = defaults::solution_manager::debugMode;
						...
						auto constexpr autoStart= defaults::solution_manager::autoStart;
						auto constexpr autoRestart = defaults::solution_manager::autoRestart;

						auto constexpr loadAfterCreation = true;
						auto constexpr enableSolutionManager = true;

						return { 
							uuid, instanceName, solutionId, groupName, persistent, frameRateLimit, metadataMode, statisticsMode, 
							diagnosticsMode, debugMode, detectorMode, detectionSensitivity, movementSensitivity, sensorModality, autoStart, autoRestart,
				...
				NODISCARD EXPORT expected<std::shared_ptr<iface::InstanceController>> cloneInstanceController(std::shared_ptr<iface::InstanceController> ctrl);
				...
				NODISCARD EXPORT bool isPaused(Uuid const& uuid);
				...
				NODISCARD EXPORT expected<void> stopInstance(Uuid const& uuid, bool allowRestart);
