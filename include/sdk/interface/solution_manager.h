	...
	namespace rt {
		...
		namespace iface {
			...
			public:
				...
				virtual float getInputFramerate() const = 0;
				virtual void setFrameRateLimit(int frameRateLimit) = 0;
				virtual int getFrameRateLimit() const = 0;
				virtual void setInputPixelLimit(int pixels) = 0;
				virtual int getInputPixelLimit() const = 0;
				...
				virtual expected<void> pushRawFrame(void const* buffer, int width, int height, std::chrono::milliseconds timestamp) = 0;
