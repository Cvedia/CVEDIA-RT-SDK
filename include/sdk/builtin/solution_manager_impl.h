	...
	namespace rt {
		namespace solution {
			...
			public:
				...
				EXPORT float getInputFramerate() const override;
				EXPORT float getAppSrcFramerate() const;
				EXPORT std::string getAppSrcResolution() const;
				...
				EXPORT void setInputPixelLimit(int pixels) override;
				EXPORT int getInputPixelLimit() const override;
				...
				EXPORT expected<void> pushRawFrame(const rt::cbuffer& image) override;
				EXPORT expected<void> pushRawFrame(void const* buffer, int width, int height, std::chrono::milliseconds timestamp) override;
				EXPORT expected<void> pushCompressedFrame(unsigned char const* data, size_t dataSize, std::chrono::milliseconds timestamp) override;
				EXPORT expected<void> pushH264Frame(unsigned char const* data, size_t dataSize, std::chrono::milliseconds timestamp) override;
				EXPORT expected<void> pushH265Frame(unsigned char const* data, size_t dataSize, std::chrono::milliseconds timestamp) override;
			...
			private:
				...
				expected<float> _getFramerate() const;
				expected<float> _getAppSrcFramerate() const;
				expected<std::string> _getAppSrcResolution() const;
