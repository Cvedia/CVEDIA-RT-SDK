...
namespace cvedia {
	namespace rt {
		...
		public:
			...
			//! \cond
			EXPORT static void registerCodecHandler(std::string const& deviceId, Codec const& codec, bool confirmedSupport, module::createVideoDecoderHandler func);
			//! \endcond
