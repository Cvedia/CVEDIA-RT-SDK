 ...
 * @param classes Pointer to an array containing the class IDs of interest (1 = Person, 2 = Animal, 3 = Vehicle, 4 = Face, 5 = Unknown).
 ...
 * @param direction The direction of line tailgating to be detected (1 = Up, 2 = Down, 3 = Both).
 * @param color Color of the line for visualization purposes
 *
 * @return Returns 1 if the line was successfully created, 0 otherwise.
 *
...
/**
 * Creates a new automatic license plate recognition area in the specified SecuRT instance.
 *
 * @param handle The context handle of the SecuRT instance.
 * @param areaId Unique identifier for the new area. Must be a null-terminated string.
 * @param name Name for the new area. Must be a null-terminated string.
 ...
 * @note The function returns 0 if the areaId already exists in the instance or if the numPoints does not match the size of the coordinates arrays.
 */
EXPORT int securt_create_alpr_area(int const handle, char const* areaId, char const* name, float const* coords,
	int numPoints, double const* color);
...
/**
 * @brief Sets the performance profile of the specified SecuRT instance.
 *
 * @param handle The context handle of the SecuRT instance.
 * @param profile The performance profile to be set (0 = Performance, 1 = Balanced, 2 = Accurate).
 *
 * @return Returns 1 if the performance profile was successfully set, 0 otherwise.
 */
EXPORT int securt_set_performance_profile(int const handle, int const profile);
