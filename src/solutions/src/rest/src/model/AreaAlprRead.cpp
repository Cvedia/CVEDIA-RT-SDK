...
#include "rt_rest_client/model/AreaAlprRead.h"
...
void AreaAlprRead::validate()
{
    // TODO: implement validation
}

web::json::value AreaAlprRead::toJson() const
{
...
bool AreaAlprRead::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AreaAlprRead::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AreaAlprRead::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t AreaAlprRead::getId() const
{
    return m_id;
}

void AreaAlprRead::setId(const utility::string_t& value)
{
    m_id = value;
    m_idIsSet = true;
}

bool AreaAlprRead::idIsSet() const
{
    return m_idIsSet;
}

void AreaAlprRead::unsetid()
{
    m_idIsSet = false;
}
utility::string_t AreaAlprRead::getName() const
{
    return m_name;
}

void AreaAlprRead::setName(const utility::string_t& value)
{
    m_name = value;
    m_nameIsSet = true;
}

bool AreaAlprRead::nameIsSet() const
{
    return m_nameIsSet;
}

void AreaAlprRead::unsetname()
{
    m_nameIsSet = false;
}
std::vector<std::shared_ptr<Coordinate>>& AreaAlprRead::getCoordinates()
{
    return m_coordinates;
}

void AreaAlprRead::setCoordinates(const std::vector<std::shared_ptr<Coordinate>>& value)
{
    m_coordinates = value;
    m_coordinatesIsSet = true;
}

bool AreaAlprRead::coordinatesIsSet() const
{
    return m_coordinatesIsSet;
}

void AreaAlprRead::unsetcoordinates()
{
    m_coordinatesIsSet = false;
}
std::vector<double>& AreaAlprRead::getColor()
{
    return m_color;
}

void AreaAlprRead::setColor(std::vector<double> value)
{
    m_color = value;
    m_colorIsSet = true;
}

bool AreaAlprRead::colorIsSet() const
{
    return m_colorIsSet;
}

void AreaAlprRead::unsetcolor()
{
    m_colorIsSet = false;
}
}
