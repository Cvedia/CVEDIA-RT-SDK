...
SecurtConsumeEventsV1_200_response_inner::SecurtConsumeEventsV1_200_response_inner()
{
...
void SecurtConsumeEventsV1_200_response_inner::validate()
{
    // TODO: implement validation
}

web::json::value SecurtConsumeEventsV1_200_response_inner::toJson() const
{
...
bool SecurtConsumeEventsV1_200_response_inner::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SecurtConsumeEventsV1_200_response_inner::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SecurtConsumeEventsV1_200_response_inner::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t SecurtConsumeEventsV1_200_response_inner::getDataType() const
{
    return m_dataType;
}

void SecurtConsumeEventsV1_200_response_inner::setDataType(const utility::string_t& value)
{
    m_dataType = value;
    m_dataTypeIsSet = true;
}

bool SecurtConsumeEventsV1_200_response_inner::dataTypeIsSet() const
{
    return m_dataTypeIsSet;
}

void SecurtConsumeEventsV1_200_response_inner::unsetdataType()
{
    m_dataTypeIsSet = false;
}
utility::string_t SecurtConsumeEventsV1_200_response_inner::getJsonObject() const
{
    return m_jsonObject;
}

void SecurtConsumeEventsV1_200_response_inner::setJsonObject(const utility::string_t& value)
{
    m_jsonObject = value;
    m_jsonObjectIsSet = true;
}

bool SecurtConsumeEventsV1_200_response_inner::jsonObjectIsSet() const
{
    return m_jsonObjectIsSet;
}

void SecurtConsumeEventsV1_200_response_inner::unsetjsonObject()
{
    m_jsonObjectIsSet = false;
}
}
