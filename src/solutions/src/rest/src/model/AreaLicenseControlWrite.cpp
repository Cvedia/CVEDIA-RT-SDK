...
#include "rt_rest_client/model/AreaLicenseControlWrite.h"
...
AreaLicenseControlWrite::AreaLicenseControlWrite()
{
...
void AreaLicenseControlWrite::validate()
{
    // TODO: implement validation
}

web::json::value AreaLicenseControlWrite::toJson() const
{
...
bool AreaLicenseControlWrite::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AreaLicenseControlWrite::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AreaLicenseControlWrite::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t AreaLicenseControlWrite::getName() const
{
    return m_name;
}

void AreaLicenseControlWrite::setName(const utility::string_t& value)
{
    m_name = value;
    m_nameIsSet = true;
}

bool AreaLicenseControlWrite::nameIsSet() const
{
    return m_nameIsSet;
}

void AreaLicenseControlWrite::unsetname()
{
    m_nameIsSet = false;
}
std::vector<std::shared_ptr<Coordinate>>& AreaLicenseControlWrite::getCoordinates()
{
    return m_coordinates;
}

void AreaLicenseControlWrite::setCoordinates(const std::vector<std::shared_ptr<Coordinate>>& value)
{
    m_coordinates = value;
    m_coordinatesIsSet = true;
}

bool AreaLicenseControlWrite::coordinatesIsSet() const
{
    return m_coordinatesIsSet;
}

void AreaLicenseControlWrite::unsetcoordinates()
{
    m_coordinatesIsSet = false;
}
std::vector<double>& AreaLicenseControlWrite::getColor()
{
    return m_color;
}

void AreaLicenseControlWrite::setColor(std::vector<double> value)
{
    m_color = value;
    m_colorIsSet = true;
}

bool AreaLicenseControlWrite::colorIsSet() const
{
    return m_colorIsSet;
}

void AreaLicenseControlWrite::unsetcolor()
{
    m_colorIsSet = false;
}
}
