...
web::json::value SecuRTInstanceWrite::toJson() const
{
    ...
    if(m_forceRecreateIsSet)
    {
        val[utility::conversions::to_string_t(U("forceRecreate"))] = ModelBase::toJson(m_forceRecreate);
    }
    if(m_debugModeIsSet)
    {
...
bool SecuRTInstanceWrite::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("forceRecreate"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(U("forceRecreate")));
        if(!fieldValue.is_null())
        {
            bool refVal_setForceRecreate;
            ok &= ModelBase::fromJson(fieldValue, refVal_setForceRecreate);
            setForceRecreate(refVal_setForceRecreate);
        }
    }
...
void SecuRTInstanceWrite::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_forceRecreateIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("forceRecreate")), m_forceRecreate));
    }
    if(m_debugModeIsSet)
    {
...
bool SecuRTInstanceWrite::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(U("forceRecreate"))))
    {
        bool refVal_setForceRecreate;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("forceRecreate"))), refVal_setForceRecreate );
        setForceRecreate(refVal_setForceRecreate);
    }
...
bool SecuRTInstanceWrite::isForceRecreate() const
{
    return m_forceRecreate;
}

void SecuRTInstanceWrite::setForceRecreate(bool value)
{
    m_forceRecreate = value;
    m_forceRecreateIsSet = true;
}

bool SecuRTInstanceWrite::forceRecreateIsSet() const
{
    return m_forceRecreateIsSet;
}

void SecuRTInstanceWrite::unsetforceRecreate()
{
    m_forceRecreateIsSet = false;
}
