...
CorePostInstanceStateV1_request::CorePostInstanceStateV1_request()
{
...
void CorePostInstanceStateV1_request::validate()
{
    // TODO: implement validation
}

web::json::value CorePostInstanceStateV1_request::toJson() const
{
...
bool CorePostInstanceStateV1_request::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CorePostInstanceStateV1_request::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CorePostInstanceStateV1_request::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t CorePostInstanceStateV1_request::getPath() const
{
    return m_path;
}

void CorePostInstanceStateV1_request::setPath(const utility::string_t& value)
{
    m_path = value;
    m_pathIsSet = true;
}

bool CorePostInstanceStateV1_request::pathIsSet() const
{
    return m_pathIsSet;
}

void CorePostInstanceStateV1_request::unsetpath()
{
    m_pathIsSet = false;
}
utility::string_t CorePostInstanceStateV1_request::getJsonValue() const
{
    return m_jsonValue;
}

void CorePostInstanceStateV1_request::setJsonValue(const utility::string_t& value)
{
    m_jsonValue = value;
    m_jsonValueIsSet = true;
}

bool CorePostInstanceStateV1_request::jsonValueIsSet() const
{
    return m_jsonValueIsSet;
}

void CorePostInstanceStateV1_request::unsetjsonValue()
{
    m_jsonValueIsSet = false;
}
}
