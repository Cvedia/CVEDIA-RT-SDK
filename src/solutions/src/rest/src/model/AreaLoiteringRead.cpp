...
#include "securt_rest_client/model/AreaLoiteringRead.h"
...
AreaLoiteringRead::AreaLoiteringRead()
{
...
void AreaLoiteringRead::validate()
{
    // TODO: implement validation
}

web::json::value AreaLoiteringRead::toJson() const
{
...
bool AreaLoiteringRead::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AreaLoiteringRead::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AreaLoiteringRead::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t AreaLoiteringRead::getId() const
{
    return m_id;
}

void AreaLoiteringRead::setId(const utility::string_t& value)
{
    m_id = value;
    m_idIsSet = true;
}

bool AreaLoiteringRead::idIsSet() const
{
    return m_idIsSet;
}

void AreaLoiteringRead::unsetid()
{
    m_idIsSet = false;
}
utility::string_t AreaLoiteringRead::getName() const
{
    return m_name;
}

void AreaLoiteringRead::setName(const utility::string_t& value)
{
    m_name = value;
    m_nameIsSet = true;
}

bool AreaLoiteringRead::nameIsSet() const
{
    return m_nameIsSet;
}

void AreaLoiteringRead::unsetname()
{
    m_nameIsSet = false;
}
std::vector<std::shared_ptr<Coordinate>>& AreaLoiteringRead::getCoordinates()
{
    return m_coordinates;
}

void AreaLoiteringRead::setCoordinates(const std::vector<std::shared_ptr<Coordinate>>& value)
{
    m_coordinates = value;
    m_coordinatesIsSet = true;
}

bool AreaLoiteringRead::coordinatesIsSet() const
{
    return m_coordinatesIsSet;
}

void AreaLoiteringRead::unsetcoordinates()
{
    m_coordinatesIsSet = false;
}
std::vector<std::shared_ptr<Class>>& AreaLoiteringRead::getClasses()
{
    return m_classes;
}

void AreaLoiteringRead::setClasses(const std::vector<std::shared_ptr<Class>>& value)
{
    m_classes = value;
    m_classesIsSet = true;
}

bool AreaLoiteringRead::classesIsSet() const
{
    return m_classesIsSet;
}

void AreaLoiteringRead::unsetclasses()
{
    m_classesIsSet = false;
}
int32_t AreaLoiteringRead::getSeconds() const
{
    return m_seconds;
}

void AreaLoiteringRead::setSeconds(int32_t value)
{
    m_seconds = value;
    m_secondsIsSet = true;
}

bool AreaLoiteringRead::secondsIsSet() const
{
    return m_secondsIsSet;
}

void AreaLoiteringRead::unsetseconds()
{
    m_secondsIsSet = false;
}
std::vector<double>& AreaLoiteringRead::getColor()
{
    return m_color;
}

void AreaLoiteringRead::setColor(std::vector<double> value)
{
    m_color = value;
    m_colorIsSet = true;
}

bool AreaLoiteringRead::colorIsSet() const
{
    return m_colorIsSet;
}

void AreaLoiteringRead::unsetcolor()
{
    m_colorIsSet = false;
}
}
