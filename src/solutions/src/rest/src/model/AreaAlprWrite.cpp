...
void AreaAlprWrite::validate()
{
    // TODO: implement validation
}

web::json::value AreaAlprWrite::toJson() const
{
...
bool AreaAlprWrite::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AreaAlprWrite::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AreaAlprWrite::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t AreaAlprWrite::getName() const
{
    return m_name;
}

void AreaAlprWrite::setName(const utility::string_t& value)
{
    m_name = value;
    m_nameIsSet = true;
}

bool AreaAlprWrite::nameIsSet() const
{
    return m_nameIsSet;
}

void AreaAlprWrite::unsetname()
{
    m_nameIsSet = false;
}
std::vector<std::shared_ptr<Coordinate>>& AreaAlprWrite::getCoordinates()
{
    return m_coordinates;
}

void AreaAlprWrite::setCoordinates(const std::vector<std::shared_ptr<Coordinate>>& value)
{
    m_coordinates = value;
    m_coordinatesIsSet = true;
}

bool AreaAlprWrite::coordinatesIsSet() const
{
    return m_coordinatesIsSet;
}

void AreaAlprWrite::unsetcoordinates()
{
    m_coordinatesIsSet = false;
}
std::vector<double>& AreaAlprWrite::getColor()
{
    return m_color;
}

void AreaAlprWrite::setColor(std::vector<double> value)
{
    m_color = value;
    m_colorIsSet = true;
}

bool AreaAlprWrite::colorIsSet() const
{
    return m_colorIsSet;
}

void AreaAlprWrite::unsetcolor()
{
    m_colorIsSet = false;
}
}
