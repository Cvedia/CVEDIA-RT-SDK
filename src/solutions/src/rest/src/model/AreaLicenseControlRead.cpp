...
#include "rt_rest_client/model/AreaLicenseControlRead.h"
...
AreaLicenseControlRead::AreaLicenseControlRead()
{
...
void AreaLicenseControlRead::validate()
{
    // TODO: implement validation
}

web::json::value AreaLicenseControlRead::toJson() const
{
...
bool AreaLicenseControlRead::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void AreaLicenseControlRead::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool AreaLicenseControlRead::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t AreaLicenseControlRead::getId() const
{
    return m_id;
}

void AreaLicenseControlRead::setId(const utility::string_t& value)
{
    m_id = value;
    m_idIsSet = true;
}

bool AreaLicenseControlRead::idIsSet() const
{
    return m_idIsSet;
}

void AreaLicenseControlRead::unsetid()
{
    m_idIsSet = false;
}
utility::string_t AreaLicenseControlRead::getName() const
{
    return m_name;
}

void AreaLicenseControlRead::setName(const utility::string_t& value)
{
    m_name = value;
    m_nameIsSet = true;
}

bool AreaLicenseControlRead::nameIsSet() const
{
    return m_nameIsSet;
}

void AreaLicenseControlRead::unsetname()
{
    m_nameIsSet = false;
}
std::vector<std::shared_ptr<Coordinate>>& AreaLicenseControlRead::getCoordinates()
{
    return m_coordinates;
}

void AreaLicenseControlRead::setCoordinates(const std::vector<std::shared_ptr<Coordinate>>& value)
{
    m_coordinates = value;
    m_coordinatesIsSet = true;
}

bool AreaLicenseControlRead::coordinatesIsSet() const
{
    return m_coordinatesIsSet;
}

void AreaLicenseControlRead::unsetcoordinates()
{
    m_coordinatesIsSet = false;
}
std::vector<double>& AreaLicenseControlRead::getColor()
{
    return m_color;
}

void AreaLicenseControlRead::setColor(std::vector<double> value)
{
    m_color = value;
    m_colorIsSet = true;
}

bool AreaLicenseControlRead::colorIsSet() const
{
    return m_colorIsSet;
}

void AreaLicenseControlRead::unsetcolor()
{
    m_colorIsSet = false;
}
}
