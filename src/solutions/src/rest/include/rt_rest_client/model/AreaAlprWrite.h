...
#ifndef CVEDIA_RT_REST_CLIENT_MODEL_AreaAlprWrite_H_
#define CVEDIA_RT_REST_CLIENT_MODEL_AreaAlprWrite_H_
...
/// 
/// </summary>
class EXPORT_CLASS  AreaAlprWrite
    : public ModelBase
{
public:
    EXPORT AreaAlprWrite();
    EXPORT virtual ~AreaAlprWrite();
...
#endif /* CVEDIA_RT_REST_CLIENT_MODEL_AreaAlprWrite_H_ */
