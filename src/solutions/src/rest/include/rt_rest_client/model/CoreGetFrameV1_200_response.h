...
/*
 * CoreGetFrameV1_200_response.h
 *
 * 
 */

#ifndef CVEDIA_RT_REST_CLIENT_MODEL_CoreGetFrameV1_200_response_H_
#define CVEDIA_RT_REST_CLIENT_MODEL_CoreGetFrameV1_200_response_H_
...
/// 
/// </summary>
class EXPORT_CLASS  CoreGetFrameV1_200_response
    : public ModelBase
{
public:
    EXPORT CoreGetFrameV1_200_response();
    EXPORT virtual ~CoreGetFrameV1_200_response();
    ...
    /////////////////////////////////////////////
    /// CoreGetFrameV1_200_response members

    /// <summary>
    /// 
    /// </summary>
    EXPORT utility::string_t getFrame() const;
    EXPORT bool frameIsSet() const;
    EXPORT void unsetframe();

    EXPORT void setFrame(const utility::string_t& value);
...
#endif /* CVEDIA_RT_REST_CLIENT_MODEL_CoreGetFrameV1_200_response_H_ */
