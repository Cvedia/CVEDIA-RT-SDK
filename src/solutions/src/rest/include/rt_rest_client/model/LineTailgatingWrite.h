...
/*
 * LineTailgatingWrite.h
 *
 * 
 */

#ifndef CVEDIA_RT_REST_CLIENT_MODEL_LineTailgatingWrite_H_
#define CVEDIA_RT_REST_CLIENT_MODEL_LineTailgatingWrite_H_
...
/// 
/// </summary>
class EXPORT_CLASS  LineTailgatingWrite
    : public ModelBase
{
public:
    EXPORT LineTailgatingWrite();
    EXPORT virtual ~LineTailgatingWrite();
...
#endif /* CVEDIA_RT_REST_CLIENT_MODEL_LineTailgatingWrite_H_ */
