...
/*
 * AreaFallenPersonWrite.h
 *
 * 
 */

#ifndef CVEDIA_RT_REST_CLIENT_MODEL_AreaFallenPersonWrite_H_
#define CVEDIA_RT_REST_CLIENT_MODEL_AreaFallenPersonWrite_H_
...
/// 
/// </summary>
class EXPORT_CLASS  AreaFallenPersonWrite
    : public ModelBase
{
public:
    EXPORT AreaFallenPersonWrite();
    EXPORT virtual ~AreaFallenPersonWrite();
...
#endif /* CVEDIA_RT_REST_CLIENT_MODEL_AreaFallenPersonWrite_H_ */
