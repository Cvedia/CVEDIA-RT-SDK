...
/*
 * AreaArmedPersonRead.h
 *
 * 
 */

#ifndef CVEDIA_RT_REST_CLIENT_MODEL_AreaArmedPersonRead_H_
#define CVEDIA_RT_REST_CLIENT_MODEL_AreaArmedPersonRead_H_
...
/// 
/// </summary>
class EXPORT_CLASS  AreaArmedPersonRead
    : public ModelBase
{
public:
    EXPORT AreaArmedPersonRead();
    EXPORT virtual ~AreaArmedPersonRead();
...
#endif /* CVEDIA_RT_REST_CLIENT_MODEL_AreaArmedPersonRead_H_ */
