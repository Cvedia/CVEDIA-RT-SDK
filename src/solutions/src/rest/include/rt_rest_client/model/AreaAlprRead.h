...
#ifndef CVEDIA_RT_REST_CLIENT_MODEL_AreaAlprRead_H_
#define CVEDIA_RT_REST_CLIENT_MODEL_AreaAlprRead_H_
...
/// 
/// </summary>
class EXPORT_CLASS  AreaAlprRead
    : public ModelBase
{
public:
    EXPORT AreaAlprRead();
    EXPORT virtual ~AreaAlprRead();
...
#endif /* CVEDIA_RT_REST_CLIENT_MODEL_AreaAlprRead_H_ */
