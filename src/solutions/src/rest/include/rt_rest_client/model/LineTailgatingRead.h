...
/*
 * LineTailgatingRead.h
 *
 * 
 */

#ifndef CVEDIA_RT_REST_CLIENT_MODEL_LineTailgatingRead_H_
#define CVEDIA_RT_REST_CLIENT_MODEL_LineTailgatingRead_H_
...
/// 
/// </summary>
class EXPORT_CLASS  LineTailgatingRead
    : public ModelBase
{
public:
    EXPORT LineTailgatingRead();
    EXPORT virtual ~LineTailgatingRead();
...
#endif /* CVEDIA_RT_REST_CLIENT_MODEL_LineTailgatingRead_H_ */
