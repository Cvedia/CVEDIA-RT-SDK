...
#ifndef CVEDIA_RT_REST_CLIENT_MODEL_AreaCrossingWrite_H_
#define CVEDIA_RT_REST_CLIENT_MODEL_AreaCrossingWrite_H_
...
/// 
/// </summary>
class EXPORT_CLASS  AreaCrossingWrite
    : public ModelBase
{
public:
    EXPORT AreaCrossingWrite();
    EXPORT virtual ~AreaCrossingWrite();
...
#endif /* CVEDIA_RT_REST_CLIENT_MODEL_AreaCrossingWrite_H_ */
