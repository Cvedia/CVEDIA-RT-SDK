...
/*
 * AreaIntrusionWrite.h
 *
 * 
 */

#ifndef CVEDIA_RT_REST_CLIENT_MODEL_AreaIntrusionWrite_H_
#define CVEDIA_RT_REST_CLIENT_MODEL_AreaIntrusionWrite_H_
...
/// 
/// </summary>
class EXPORT_CLASS  AreaIntrusionWrite
    : public ModelBase
{
public:
    EXPORT AreaIntrusionWrite();
    EXPORT virtual ~AreaIntrusionWrite();
...
#endif /* CVEDIA_RT_REST_CLIENT_MODEL_AreaIntrusionWrite_H_ */
