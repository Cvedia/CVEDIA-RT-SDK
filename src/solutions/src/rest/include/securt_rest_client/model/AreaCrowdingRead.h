...
#ifndef CVEDIA_RT_REST_CLIENT_MODEL_AreaCrowdingRead_H_
#define CVEDIA_RT_REST_CLIENT_MODEL_AreaCrowdingRead_H_
...
/// 
/// </summary>
class EXPORT_CLASS  AreaCrowdingRead
    : public ModelBase
{
public:
    EXPORT AreaCrowdingRead();
    EXPORT virtual ~AreaCrowdingRead();
...
#endif /* CVEDIA_RT_REST_CLIENT_MODEL_AreaCrowdingRead_H_ */
