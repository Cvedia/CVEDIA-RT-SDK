...
#ifndef CVEDIA_RT_REST_CLIENT_MODEL_LineCrossingRead_H_
#define CVEDIA_RT_REST_CLIENT_MODEL_LineCrossingRead_H_
...
/// 
/// </summary>
class EXPORT_CLASS  LineCrossingRead
    : public ModelBase
{
public:
    EXPORT LineCrossingRead();
    EXPORT virtual ~LineCrossingRead();
...
#endif /* CVEDIA_RT_REST_CLIENT_MODEL_LineCrossingRead_H_ */
