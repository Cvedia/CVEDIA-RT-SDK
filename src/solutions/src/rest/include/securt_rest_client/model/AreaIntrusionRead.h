...
#ifndef CVEDIA_RT_REST_CLIENT_MODEL_AreaIntrusionRead_H_
#define CVEDIA_RT_REST_CLIENT_MODEL_AreaIntrusionRead_H_
...
/// 
/// </summary>
class EXPORT_CLASS  AreaIntrusionRead
    : public ModelBase
{
public:
    EXPORT AreaIntrusionRead();
    EXPORT virtual ~AreaIntrusionRead();
...
#endif /* CVEDIA_RT_REST_CLIENT_MODEL_AreaIntrusionRead_H_ */
