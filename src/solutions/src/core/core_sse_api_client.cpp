...
using namespace cvedia::rt::rest::client;

CoreSseApiClient::CoreSseApiClient(std::string const& server)
{
	server_ = server;
}

CoreSseApiClient::~CoreSseApiClient()
{
...
std::string CoreSseApiClient::coreConsumeEventsSse(std::string const& instanceId)
{
