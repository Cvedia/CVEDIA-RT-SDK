	...
	namespace rt {
		...
		namespace api {
			namespace thread {
				...
				EXPORT expected < std::unique_lock<__shared_mutex_class>> getWriteLock(); // TODO: @AJ to remove
				EXPORT expected < std::shared_lock<__shared_mutex_class>> getReadLock(); // TODO: @AJ to remove
